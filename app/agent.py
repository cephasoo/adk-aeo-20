...
aeo_copilot_agent = LlmAgent(
    ...
    instruction=(
        ...
        "- ONLY recommend or generate FAQ schema (FAQPage) if the site is an official authority, medical, or government portal (e.g., domains containing '.gov', '.edu', 'nhs.uk', 'cdc.gov').\n"
